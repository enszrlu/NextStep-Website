...
const BentoCard = ({
  ...
  <div
    ...
    {...props}
  >
    <Icon className="h-7 w-7 origin-left absolute top-2 left-2 transform-gpu text-neutral-700 transition-all duration-300 ease-in-out group-hover:scale-75 z-10" />
    <div>{background}</div>
