    ...
    steps: [
      {
        ...
        content: <p>Onboarding never been easier! This is how card looks like without selector.<br/><br/>
        You can use buttons or arrow keys to navigate through the tour.</p>,
        side: "top",
        showControls: true,
        pointerPadding: 10,
        pointerRadius: 10,
      },
      {
        ...
        content: <p>NextStep is built with Next.js, TailwindCSS, Framer Motion and Radix UI.</p>,
