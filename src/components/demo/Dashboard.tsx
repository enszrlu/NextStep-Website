...
export function DashboardDemo() {
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-1 sm:flex-row sm:p-8">
      <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        <Card className="lg:max-w-md" x-chunk="charts-01-chunk-0" id="chart-2">
      ...
      <div className="grid w-full flex-1 gap-6 lg:max-w-[20rem]">
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-4" id="chart-1">
